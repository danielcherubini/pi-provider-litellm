...
describe('createMcpToolDefinitions', () => {
  ...
  it('produces correct mcp_{server}_{tool} names', () => {
    const defs = createMcpToolDefinitions(mockConfig, mockToken, mockMcpTools)
  ...
  it('uses fallback args schema for unparseable input_schema', () => {
    const defs = createMcpToolDefinitions(mockConfig, mockToken, [
      {
        name: 'broken',
        server_name: 'test',
...
describe('createSkillToolDefinitions', () => {
  it('returns 5 tools', () => {
    const defs = createSkillToolDefinitions(mockConfig, mockToken)
...
describe('createSkillsInjector', () => {
  ...
  it('returns null when no enabled skills', async () => {
    ...
    const injector = createSkillsInjector(mockConfig, mockToken)
